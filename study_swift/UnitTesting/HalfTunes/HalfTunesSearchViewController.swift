...
class HalfTunesSearchViewController: UIViewController {
  ...
  lazy var tapRecognizer: UITapGestureRecognizer = {
    var recognizer = UITapGestureRecognizer(target:self, action: #selector(HalfTunesSearchViewController.dismissKeyboard))
    return recognizer
  }()
...
extension HalfTunesSearchViewController: UISearchBarDelegate {
...
extension HalfTunesSearchViewController: TrackCellDelegate {
...
extension HalfTunesSearchViewController: UITableViewDataSource {
...
extension HalfTunesSearchViewController: UITableViewDelegate {
...
extension HalfTunesSearchViewController: URLSessionDownloadDelegate {
...
extension HalfTunesSearchViewController: URLSessionDelegate {
